...
cell 0_0
cop addr_init0
calc mode=1, operand1_sd=0, operand1=0, operand2_sd=0, operand2=0, result=0
cell 2_0
cop addr_init2
calc mode=1, operand1_sd=0, operand1=0, operand2_sd=0, operand2=0, result=0
}
...
dsu slot=1, port=0, init_addr_sd=1, init_addr=0
...
dsu slot=1, port=1, init_addr_sd=1, init_addr=0
...
cell 0_0
cop addr_calc0
calc mode=1, operand1_sd=1, operand1=0, operand2_sd=0, operand2=2, result=0
cell 2_0
cop addr_calc2
calc mode=1, operand1_sd=1, operand1=0, operand2_sd=0, operand2=2, result=0
}
