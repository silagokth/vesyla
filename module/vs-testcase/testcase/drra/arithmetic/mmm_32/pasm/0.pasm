...
rep (slot=1, port=0, level=0, iter=2, step=1, delay=0)
rep (slot=1, port=0, level=1, iter=32, step=2, delay=t1)
}
rop <input_w_b> (slot=1, port=2) {
dsu (slot=1, port=2, init_addr=2)
rep (slot=1, port=2, level=0, iter=2, step=1, delay=0)
rep (slot=1, port=2, level=1, iter=32, step=0, delay=t1)
}
rop <read_b> (slot=2, port=3) {
dsu (slot=2, port=3, init_addr=2)
rep (slot=2, port=3, level=0, iter=2, step=1, delay=0)
rep (slot=2, port=3, level=1, iter=32, step=0, delay=t1)
}
}
cell (x=1, y=0) {
rop <route1wr> (slot=0, port=2) {
...
rep (slot=2, port=2, level=1, iter=32, step=0, delay=t1)
}
