...
rop <input_r_a> (slot=1, port=0) {
dsu (slot=1, port=0, init_addr=0)
rep (slot=1, port=0, level=0, iter=1, step=1, delay=0)
}
rop <input_w_a> (slot=1, port=2) {
...
rep (slot=1, port=0, level=0, iter=1, step=1, delay=0)
rep (slot=1, port=0, level=1, iter=31, step=2, delay=t1)
}
rop <input_w_b> (slot=1, port=2) {
dsu (slot=1, port=2, init_addr=2)
rep (slot=1, port=2, level=0, iter=1, step=1, delay=0)
rep (slot=1, port=2, level=1, iter=31, step=0, delay=t1)
}
rop <read_b> (slot=2, port=3) {
dsu (slot=2, port=3, init_addr=2)
rep (slot=2, port=3, level=0, iter=1, step=1, delay=0)
rep (slot=2, port=3, level=1, iter=31, step=0, delay=t1)
}
}
cell (x=1, y=0) {
rop <route1wr> (slot=0, port=2) {
...
rep (slot=2, port=2, level=1, iter=31, step=0, delay=t1)
}
...
rep (slot=1, port=1, level=1, iter=31, step=0, delay=t2)
}
rop <read_b_seq> (slot=2, port=1) {
dsu (slot=2, port=1, init_addr=0)
rep (slot=2, port=1, level=0, iter=31, step=1, delay=0)
rep (slot=2, port=1, level=1, iter=31, step=0, delay=t2)
}
rop <write_c_seq> (slot=3, port=0) {
dsu (slot=3, port=0, init_addr=0)
rep (slot=3, port=0, level=0, iter=31, step=1, delay=t4)
}
rop <compute> (slot=4, port=0) {
dpu (slot=4, mode=8)
rep (slot=4, level=0, iter=31, step=1, delay=t4)
}
