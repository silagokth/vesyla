...
rep (slot=1, port=0, level=0, iter=2, step=32, delay=0)
rep (slot=1, port=0, level=1, iter=32, step=1, delay=0)
}
rop <input_w> (slot=1, port=2) {
dsu (slot=1, port=2, init_addr=0)
rep (slot=1, port=2, iter=64, step=1, delay=0)
}
...
rep (slot=1, port=2, level=1, iter=8, step=0, delay=t1x)
}
rop <write_b> (slot=2, port=2) {
dsu (slot=2, port=2, init_addr=0)
rep (slot=2, port=2, level=0, iter=4, step=1, delay=1)
rep (slot=2, port=2, level=1, iter=8, step=0, delay=t1x)
}
...
rep (slot=1, port=1, level=1, iter=8, step=0, delay=t2)
}
rop <read_b_seq> (slot=2, port=1) {
dsu (slot=2, port=1, init_addr=0)
rep (slot=2, port=1, level=0, iter=64, step=1, delay=0)
rep (slot=2, port=1, level=1, iter=8, step=0, delay=t2)
}
rop <write_c_seq> (slot=3, port=0) {
dsu (slot=3, port=0, init_addr=0)
rep (slot=3, port=0, level=0, iter=64, step=1, delay=0)
rep (slot=3, port=0, level=1, iter=8, step=0, delay=t2)
}
...
rep (slot=3, port=3, level=1, iter=8, step=0, delay=t3)
}
}
cell (x=2, y=0) {
...
rep (slot=2, port=2, level=1, iter=8, step=4, delay=t3)
}
rop <output_r> (slot=1, port=3) {
dsu (slot=1, port=3, init_addr=0)
rep (slot=1, port=3, iter=32, step=1, delay=0)
}
