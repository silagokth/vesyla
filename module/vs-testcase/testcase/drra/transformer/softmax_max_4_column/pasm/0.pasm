...
rep (slot=2, port=3, level=1, iter=0, step=8, delay=56)
...
rep (slot=0, port=2, level=0, iter=0, delay=10)
...
rep (slot=0, port=2, level=0, iter=0, delay=0)
...
dsu (slot=1, port=1, init_addr=0)
rep (slot=1, port=1, level=0, iter=1, step=16, delay=1)
