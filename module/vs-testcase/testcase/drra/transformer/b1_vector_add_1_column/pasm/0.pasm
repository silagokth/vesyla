epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=0, iter=2, step=16, delay=0)
            rep (slot=1, port=0, level=1, iter=16, step=1, delay=0)   
            dsu (slot=1, port=2, init_addr=0)
            rep (slot=1, port=2, level=0, iter=2, step=16, delay=0)
            rep (slot=1, port=2, level=1, iter=16, step=1, delay=0)

            # read x_matrix first
            dsu (slot=2, port=3, init_addr=0)
            rep (slot=2, port=3, level=0, iter=2, step=16, delay=0)
    ...
    cell (x=1, y=0){
        raw{
            ...
            rep (slot=3, port=3, level=1, iter=4, step=0, delay=15)
    ...
    cell (x=2, y=0){
        raw{
            ...
            rep (slot=2, port=2, level=1, iter=4, step=4, delay=15)
            repx (slot=2, port=2, level=1, iter=0, step=0, delay=0)
            act (mode=0, param=2, ports=0b0100)
