epoch <rb0> {
    ...
    cell (x=1, y=0){
        raw{
            ...
            rep (slot=0, port=2, level=0, iter=5, delay=52)
            ...
            rep (slot=3, port=2, level=0, iter=1, step=1, delay=0)
            ...
            rep (slot=3, port=1, level=0, iter=0, step=0, delay=0)
            repx (slot=3, port=1, level=0, iter=4, step=0, delay=0)
