epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=0, iter=16, step=1, delay=0)
            # 1024/16 = 64 iter=64
            rep (slot=1, port=0, level=1, iter=32, step=16, delay=48)
            repx (slot=1, port=0, level=1, iter=0, step=0, delay=3)

            dsu (slot=1, port=2, init_addr=32)
            rep (slot=1, port=2, level=0, iter=16, step=1, delay=0)
            # 1024/16 = 64 iter=64
            rep (slot=1, port=2, level=1, iter=32, step=0, delay=48)
            repx (slot=1, port=2, level=1, iter=0, step=0, delay=3)
            wait (cycle=6)
            act (mode=0, param=1, ports=0b0101)
            ...
            rep (slot=2, port=3, level=0, iter=2, step=32, delay=0)
            ...
            #repeat 64 times
            rep (slot=2, port=3, level=3, iter=32, step=0, delay=56)
            repx (slot=2, port=3, level=3, iter=0, step=0, delay=0)
    ...
    cell (x=1, y=0){
        raw{
           # build incoming route
            ...
            #repeat 256 times
            rep (slot=1, port=1, level=2, iter=32, step=0, delay=0)
            ...
            #repeat 256 times
            rep (slot=2, port=1, level=2, iter=32, step=0, delay=0)
            ...
            repx (slot=1, port=2, level=1, iter=0, step=0, delay=0)
            rep (slot=1, port=2, level=2, iter=32, step=0, delay=57)
            repx (slot=1, port=2, level=2, iter=0, step=0, delay=0)
            ...
            rep (slot=4, level=0, iter=32, step=0, delay=63)
            repx (slot=4, level=0, iter=0, step=0, delay=3)
            ...
            rep (slot=3, port=0, level=0, iter=32, step=1, delay=63)
            repx (slot=3, port=0, level=0, iter=0, step=0, delay=3)
            wait (cycle=251)
            act (ports=1, param=3)
