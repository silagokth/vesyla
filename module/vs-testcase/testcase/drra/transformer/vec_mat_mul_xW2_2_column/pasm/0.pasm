epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=0, iter=15, step=1, delay=0)
            # 1024/16 = 64 iter=63
            rep (slot=1, port=0, level=1, iter=31, step=16, delay=48)
            repx (slot=1, port=0, level=1, iter=-1, step=0, delay=3)

            dsu (slot=1, port=2, init_addr=32)
            rep (slot=1, port=2, level=0, iter=15, step=1, delay=0)
            # 1024/16 = 64 iter=63
            rep (slot=1, port=2, level=1, iter=31, step=0, delay=48)
            ...
            #repeat 64 times
            rep (slot=2, port=3, level=3, iter=31, step=0, delay=56)
    ...
    cell (x=1, y=0){
        raw{
           # build incoming route
            ...
            #repeat 256 times
            rep (slot=1, port=1, level=2, iter=31, step=0, delay=0)
            ...
            #repeat 256 times
            rep (slot=2, port=1, level=2, iter=31, step=0, delay=0)
            ...
            rep (slot=1, port=2, level=2, iter=31, step=0, delay=57)
            ...
            rep (slot=4, level=0, iter=31, step=0, delay=63)
            ...
            rep (slot=3, port=0, level=0, iter=31, step=1, delay=63)
