epoch <rb0> {
    ...
    cell (x=1, y=0){
        raw{
           # build incoming route
            ...
            rep (slot=2, port=2, level=1, iter=2, step=0, delay=57)
            ...
            rep (slot=2, port=1, level=1, iter=2, step=0, delay=0)
            ...
            rep (slot=3, port=3, level=1, iter=2, step=0, delay=15)
    ...
    cell (x=2, y=0){
        raw{
            ...
            rep (slot=2, port=2, level=1, iter=2, step=4, delay=15)
            repx (slot=2, port=2, level=1, iter=0, step=0, delay=0)
            act (mode=0, param=2, ports=0b0100)
