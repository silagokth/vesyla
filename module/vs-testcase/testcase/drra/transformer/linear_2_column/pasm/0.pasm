...
rep (slot=1, port=2, level=1, step=0, iter=15, delay=32)
...
rep (slot=2, port=3, level=2, iter=15, step=0, delay=57)
...
rep (slot=1, port=3, level=0, iter=7, step=1, delay=63)
repx (slot=1, port=3, level=0, iter=-1, step=0, delay=15)
dsu (slot=1, port=1, init_addr=0)
rep (slot=1, port=1, level=0, iter=7, step=1, delay=63)
