epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=1, iter=16, step=0, delay=0) 
            ...
            rep (slot=1, port=2, level=1, iter=16, step=0, delay=0)
            ...
            rep (slot=2, port=3, level=2, iter=16, step=0, delay=60)
    ...
    cell (x=1, y=0){
        raw{
            ...
            rep (slot=4, level=1, iter=16, step=0, delay=63)
            ...
            rep (slot=2, port=2, level=2, iter=16, step=0, delay=60)
            ...
            rep (slot=3, port=0, level=1, iter=16, step=0, delay=63)
            ...
            rep (slot=3, port=3, level=0, iter=16, step=0, delay=63)
    ...
    cell (x=2, y=0){
        raw{
            ...
            #rep (slot=2, port=2, level=1, iter=4, step=4, delay=3)
