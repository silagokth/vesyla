epoch <rb0> {
    cell (x=0, y=0) {
        raw{
            ...
            rep (slot=2, port=3, level=1, iter=0, step=4, delay=60)
    ...
    cell (x=1, y=0) {
        raw{
            ...
            dsu (slot=1, port=2, init_addr=0)
            rep (slot=1, port=2, level=0, iter=3, step=1, delay=0)
            rep (slot=1, port=2, level=1, iter=0, step=0, delay=60)
            ...
            dpu (slot=4, option=0, mode=23, immediate=0)
            act (ports=1, param=4)
    ...
    cell (x=2, y=0) {
        raw{
           # build route
            ...
            rep (slot=2, port=2, level=1, iter=0, step=4, delay=15)
