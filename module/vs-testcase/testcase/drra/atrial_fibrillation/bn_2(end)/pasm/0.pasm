...
dsu (slot=2, port=1, init_addr=0)
rep (slot=2, port=1, level=0, iter=25, step=0, delay=0)

dpu (slot=5, option=0, mode=7)
dsu (slot=3, port=0, init_addr=0)
rep (slot=3, port=0, level=0, iter=25, step=1, delay=0)

dsu (slot=3, port=1, init_addr=0)
rep (slot=3, port=1, level=0, iter=25, step=1, delay=0)

dsu (slot=4, port=1, init_addr=0)
rep (slot=4, port=1, level=0, iter=25, step=0, delay=0)

dpu (slot=7, option=0, mode=1)
dsu (slot=9, port=0, init_addr=0)
rep (slot=9, port=0, level=0, iter=25, step=1, delay=0)
