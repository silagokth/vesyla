...
rep (slot=2, port=3, level=2, iter=5, step=8, delay=2)
...
rep (slot=1, port=2, level=2, iter=5, step=0, delay=2)
...
rep (slot=4, level=2, iter=5, step=0, delay=20)
...
rep (slot=3, port=0, level=2, iter=5, step=0, delay=20)

dsu (slot=3, port=3, init_addr=0)
rep (slot=3, port=3, level=0, iter=4, step=1, delay=0)
rep (slot=3, port=3, level=1, iter=5, step=0, delay=10)
...
rep (slot=2, port=2, level=1, iter=5, step=4, delay=10)
