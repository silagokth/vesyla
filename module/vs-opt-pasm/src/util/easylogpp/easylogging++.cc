...
#include "util/easylogpp/easylogging++.h"
...
StackTrace::StackTraceEntry::StackTraceEntry(std::size_t index, const char *loc,
                                             const char *demang,
                                             const char *hex,
                                             const char *addr) {
  m_index = index;
...
const std::string VersionInfo::version(void) { return std::string("9.94.2"); }
