...
public:
   ...
   */
  static bool get(const string key, glvar_t &val);
  /**
   * \fn getb()
   ...
   * \return True if found, otherwise false.
   */
  static bool getb(const string key, bool &val);
  /**
   * \fn geti()
   ...
   */
  static bool geti(const string key, int &val);
  /**
   * \fn getf()
   ...
   * \return True if found, otherwise false.
   */
  static bool getf(const string key, float &val);
  /**
   * \fn gets()
   ...
   */
  static bool gets(const string key, string &val);
  /**
   * \fn put()
   ...
   */
  static bool put(const string key, const glvar_t val);
  /**
   * \fn putb()
   ...
   * variable. \return True if the variable already exists, otherwise false.
   */
  static bool putb(const string key, const bool val);
  /**
   * \fn puti()
   ...
   * variable. \return True if the variable already exists, otherwise false.
   */
  static bool puti(const string key, const int val);
  /**
   * \fn putf()
   ...
   */
  static bool putf(const string key, const float val);
  /**
   * \fn puts()
   ...
   * \return True if the variable already exists, otherwise false.
   */
  static bool puts(const string key, const string val);
   ...
   */
  static bool load_vars(const string filename_);
   ...
   * \return True if it's successful, otherwise false.
   */
  static bool store_vars(const string filename_);
  /**
   ...
   * \return True if it's successful, otherwise false.
   */
  static bool select_and_store_vars_white(const string filename_,
   ...
   * \return True if it's successful, otherwise false.
   */
  static bool select_and_store_vars_black(const string filename_,
                                          std::set<string> filter_);
  /**
   * \fn clear()
