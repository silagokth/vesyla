...
rep (slot=1, port=2, level=1, iter=7, step=0, delay=t1)
}
rop <write_1w_1> (slot=1, port=2) {
dsu (slot=1, port=2, init_addr=0)
rep (slot=1, port=2, level=0, iter=1, step=1, delay=0)
rep (slot=1, port=2, level=1, iter=6, step=0, delay=t3)
}
rop <write_2w> (slot=2, port=2) {
dsu (slot=2, port=2, init_addr=0)
rep (slot=2, port=2, level=0, iter=0, step=0, delay=0)
}
rop <read_1n_0> (slot=1, port=1) {
dsu (slot=1, port=1, init_addr=0)
rep (slot=1, port=1, level=0, iter=2, step=1, delay=0)
rep (slot=1, port=1, level=1, iter=61, step=1, delay=0)
rep (slot=1, port=1, level=2, iter=7, step=0, delay=6)
}
rop <read_1n_1> (slot=1, port=1) {
dsu (slot=1, port=1, init_addr=14)
rep (slot=1, port=1, level=0, iter=2, step=1, delay=0)
rep (slot=1, port=1, level=1, iter=1, step=1, delay=0)
rep (slot=1, port=1, level=2, iter=6, step=0, delay=t5)
}
rop <read_2n> (slot=2, port=1) {
dsu (slot=2, port=1, init_addr=0)
rep (slot=2, port=1, level=0, iter=2, step=1, delay=0)
rep (slot=2, port=1, level=1, iter=509, step=0, delay=0)
}
rop <compute> (slot=4, port=0) {
dpu (slot=4, option=0, mode=8)
rep (slot=4, level=0, iter=509, step=0, delay=2)
}
rop <write_3n_0> (slot=3, port=0) {
dsu (slot=3, port=0, init_addr=0)
rep (slot=3, port=0, level=0, iter=61, step=1, delay=2)
rep (slot=3, port=0, level=1, iter=7, step=0, delay=t7)
}
rop <write_3n_1> (slot=3, port=0) {
dsu (slot=3, port=0, init_addr=62)
rep (slot=3, port=0, level=0, iter=1, step=1, delay=2)
rep (slot=3, port=0, level=1, iter=6, step=0, delay=t8)
}
rop <read_3w_0> (slot=3, port=3) {
dsu (slot=3, port=3, init_addr=0)
rep (slot=3, port=3, level=0, iter=3, step=1, delay=0)
rep (slot=3, port=3, level=1, iter=6, step=0, delay=t10)
}
...
rep (slot=2, port=2, level=1, iter=6, step=4, delay=t10)
}
...
dsu (slot=1, port=1, init_addr=0)
rep (slot=1, port=1, level=0, iter=31, step=1, delay=0)
}
}
}
