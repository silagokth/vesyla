epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=2, port=3, level=1, iter=3, step=4, delay=57)
            ...
            rep (slot=1, port=0, level=2, step=0, iter=3, delay=32)
            ...
            rep (slot=1, port=2, level=1, step=0, iter=31, delay=32)
            ...
            rep (slot=2, port=3, level=2, iter=31, step=0, delay=57)
    ...
    cell (x=1, y=0){
        raw{
            ...
            repx (slot=1, port=1, level=1, iter=3, step=0, delay=0)
            ...
            repx (slot=2, port=1, level=1, iter=3, step=0, delay=0)

            dpu (slot=4, option=0, mode=8)
            rep (slot=4, level=0, iter=-1, step=0, delay=63)
            repx (slot=4, level=0, iter=3, step=0, delay=0)
            ...
            rep (slot=2, port=2, level=2, iter=31, step=0, delay=57)
            ...
            rep (slot=3, port=3, level=1, iter=3, step=0, delay=63)
    ...
    cell (x=2, y=0){
        raw{
            ...
            rep (slot=1, port=3, level=0, iter=15, step=1, delay=63)
            repx (slot=1, port=3, level=0, iter=-1, step=0, delay=15)
            dsu (slot=1, port=1, init_addr=0)
            rep (slot=1, port=1, level=0, iter=15, step=1, delay=63)
