epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=1, iter=7, step=0, delay=0)
            ...
            rep (slot=1, port=2, level=1, iter=7, step=0, delay=0)
            ...
            rep (slot=2, port=3, level=2, iter=7, step=0, delay=60)
    ...
    cell (x=1, y=0){
        raw{
            ...
            rep (slot=1, port=1, level=2, iter=7, step=0, delay=0)
            ...
            rep (slot=2, port=1, level=2, iter=7, step=0, delay=0)
            ...
            rep (slot=4, level=1, iter=7, step=0, delay=63)
            ...
            rep (slot=2, port=2, level=2, iter=7, step=0, delay=60)
            ...
            rep (slot=3, port=0, level=1, iter=7, step=0, delay=63)
            ...
            rep (slot=3, port=3, level=0, iter=7, step=0, delay=63)
    ...
    cell (x=2, y=0){
        raw{
            ...
            # write data 
            dsu (slot=2, port=2, init_addr=0)
            rep (slot=2, port=2, level=0, iter=7, step=1, delay=63)
