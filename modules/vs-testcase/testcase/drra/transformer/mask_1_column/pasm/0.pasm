epoch <rb0> {
    cell (x=0, y=0){
        raw{
            ...
            rep (slot=1, port=0, level=1, step=1, iter=31, delay=0)
            ...
            rep (slot=2, port=3, level=1, iter=7, step=8, delay=56)
    ...
    cell (x=1, y=0){
            raw{
                ...
                rep (slot=3, port=0, level=1, iter=15, step=0, delay=0)
                ...
                rep (slot=3, port=3, level=1, iter=15, step=0, delay=60)
    ...
    cell (x=2, y=0){
        raw{
            ...
            rep (slot=2, port=2, level=1, iter=15, step=4, delay=60)
            repx (slot=2, port=2, level=1, iter=-1, step=0, delay=0)

            dsu (slot=1, port=3, init_addr=0)
            rep (slot=1, port=3, level=0, iter=3, step=1, delay=0)
            rep (slot=1, port=3, level=1, iter=15, step=4, delay=60)
            repx (slot=1, port=3, level=1, iter=-1, step=0, delay=0)
            dsu (slot=1, port=1, init_addr=0)
            rep (slot=1, port=1, level=0, iter=3, step=1, delay=0)
            rep (slot=1, port=1, level=1, iter=15, step=4, delay=60)
